...
public class HTTP
{
	public static final int PUERTO=8001;
	ServerSocket ss;
		...
		class Manejador extends Thread{
			...
			public void run()
			{
				try{
					...
					File dir = new File("C:/Users/saidnDocuments/NetBeansProjects/HTTP");
		...
		{       
			...
			for(;;)
			{
				Socket accept=ss.accept();
                                Pool.submit(new Manejador(accept));
                                System.out.println("Pools en hilo: "+((ThreadPoolExecutor)Pool).getPoolSize());
			}
		}
